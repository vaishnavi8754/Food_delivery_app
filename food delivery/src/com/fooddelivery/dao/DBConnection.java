    ...
    public static Connection getConnection() {
        ...
        for (String password : commonPasswords) {
            try {
                ...
                // System.out.println("DEBUG: Failed with password: " + password + " error: " +
                // e.getMessage());
            }
        }

        System.err.println(
                "DATABASE CONNECTION FAILED: None of the common passwords worked. Please update DB_PASSWORD in DBConnection.java.");
        return null;
    }
